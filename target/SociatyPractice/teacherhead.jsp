    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarsExample03">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="javascript:doPost('${pageContext.request.contextPath}/getteacheractivity', {'id':'${sessionScope.user.id}'})">社会实践管理</a>
                </li>
                <li class="nav-item active">

                    <a class="nav-link" href="javascript:doPost('${pageContext.request.contextPath}/getprogressactivity', {'id':'${sessionScope.user.id}'})">学生进度管理</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="javascript:doPost('${pageContext.request.contextPath}/findteacherscore', {'id':'${sessionScope.user.id}'})">评分</a>
                </li>
